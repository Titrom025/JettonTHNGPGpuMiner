...
const givers_things_1 = require("./givers_things");
...
let givers = givers_things_1.GiversThings5000;
if (args['--givers']) {
    const val = args['--givers'];
    const allowed = [100, 200, 1000, 5000, 10000, 1000000];
    if (!allowed.includes(val)) {
        throw new Error('Invalid --givers argument');
    }
    switch (val) {
        case 100:
            givers = givers_things_1.GiversThings100;
            console.log('Using givers 100');
            break;
        case 200:
            givers = givers_things_1.GiversThings200;
            console.log('Using givers 200');
            break;
        case 1000:
            givers = givers_things_1.GiversThings1000;
            console.log('Using givers 1 000');
            break;
        case 5000:
            givers = givers_things_1.GiversThings5000;
            console.log('Using givers 5 000');
            break;
        case 10000:
            givers = givers_things_1.GiversThings10000;
            console.log('Using givers 10 000');
            break;
        case 1000000:
            givers = givers_things_1.GiversThings1000000;
            console.log('Using givers 1 000 000');
            break;
    }
}
else {
